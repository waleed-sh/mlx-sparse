...
[[noreturn]] void
throw_csr_sum_duplicates_autodiff_error(const char *primitive,
                                        const char *transform) {
  throw std::runtime_error(
      std::string("csr_sum_duplicates ") + transform +
...
std::vector<mx::array> CSRDuplicateCounts::jvp(const std::vector<mx::array> &,
                                               const std::vector<mx::array> &,
                                               const std::vector<int> &) {
  throw_csr_sum_duplicates_autodiff_error("CSRDuplicateCounts", "JVP");
}

std::vector<mx::array> CSRDuplicateCounts::vjp(const std::vector<mx::array> &,
                                               const std::vector<mx::array> &,
                                               const std::vector<int> &,
                                               const std::vector<mx::array> &) {
  throw_csr_sum_duplicates_autodiff_error("CSRDuplicateCounts", "VJP");
}
...
std::vector<mx::array> CSRDuplicateFill::jvp(const std::vector<mx::array> &,
                                             const std::vector<mx::array> &,
                                             const std::vector<int> &) {
  throw_csr_sum_duplicates_autodiff_error("CSRDuplicateFill", "JVP");
}

std::vector<mx::array> CSRDuplicateFill::vjp(const std::vector<mx::array> &,
                                             const std::vector<mx::array> &,
                                             const std::vector<int> &,
                                             const std::vector<mx::array> &) {
  throw_csr_sum_duplicates_autodiff_error("CSRDuplicateFill", "VJP");
}
