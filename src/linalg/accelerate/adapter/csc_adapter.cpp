...
AccelerateCscMatrixFloat::structure(SparseAttributes_t attributes) const {
...
SparseMatrix_Float
AccelerateCscMatrixFloat::matrix(SparseAttributes_t attributes) const {
  SparseMatrix_Float result{};
  result.structure = structure(attributes);
